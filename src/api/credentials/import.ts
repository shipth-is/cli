...
import { CredentialsPlatform, CredentialsType } from "./types";
...
async function getNewImportTicket(
...
export async function importCredential({
  ...
  const url = projectId
    ? `${API_URL}/projects/${projectId}/credentials/import`
    : `${API_URL}/credentials/import`;
